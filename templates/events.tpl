...
if($this->body_template_data['mode'] == 'getList'){
	...
	if($this->body_template_data[$mode_index]['records_count']==0){
		...
		for($i_ul=0; $i_ul<$this->body_template_data[$mode_index]['records_count']; $i_ul++){
				...
				require CONST_THEMES_TEMPLATE_INCLUDE_PATH.'events-row.tpl';
...
<div class="row">
    <div id='rec_list_container' class="col-12 mt-3 mb-2">
        ...
        <div class="card-body">
        	...
        	<div class="row">
                <div class="col-8 "><h4 class="row pg_heading_line_ht  ">Events&nbsp;<span id="heading_rec_cnt" style="color: #0c0c0cab;" >0</span> </h4></div>
                <div class="col-4 text-right">
                	<div class="row btns-user-add" style="float:right;">
						...
						?>		
								<a href="events.php#mode=addrec" class="btn btn-success  record-add-button"  id="add-record-button"><img src="images/plus.png" class="custom-button-small" alt="Plus"> <span class="hide_in_mobile"  >Create Event</span> </a>
        ...
        <div class="panel-search d-none pb-2">
			<?php include CONST_THEMES_TEMPLATE_INCLUDE_PATH.'events-search-form-basic.tpl'; ?>
		</div>
			...
			<table id="recs-list" class="table table-striped table-bordered table-hover">
				<thead class="thead">
					<tr>
						...
						<th class='' id="colheader_venue" ><span class="pull-left">Venue</span></th>
						...
						<th id="colheader_active"><span class="pull-left">Active</span></th>
						<th  id="colheader_regon"><span class="pull-left">Registration Is On</span></th>
					</tr>
				</thead>
	...
	<div class="col-12 mt-3 mb-2 d-none"  id='rec_detail_add_edit_container'   >
		<?php require_once CONST_THEMES_TEMPLATE_INCLUDE_PATH.'events-add.tpl';	?>
	</div>

<div id="search_records" class="row ">
	<div class=" col-lg-12 col-sm-12">
		<form class="form-inline search-form" name="search_form" onsubmit="return adfuncs.doSearch(this);">
				...
				<div class="row">
						...
						<div class="col-lg-12 col-sm-12">
							<div class="row">
								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 form-group ">
									<label class="" style="font-weight: normal; white-space: nowrap;" for="search-field_email" >Target URL</label>
									<input type="text" id="search-field_targetlink"  placeholder="Target URL has" class="form-control srchfld" style="height: 32px;width: 100%;" maxlength="300" data-type="CONTAINS" data-fld="target_link"  />
								</div>

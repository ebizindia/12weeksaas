...
// ============================================================================
// Enable SaaS mode for individual users (not organization-based)
define('CONST_SAAS_MODE', true);

// User Management Settings
define('CONST_REQUIRE_SIGNUP', false); // Phase 1: Manual user creation only via admin tool
define('CONST_MIN_PASSWORD_LENGTH', 8); // Minimum password length requirement
define('CONST_ALLOW_USER_DELETE_ACCOUNT', false); // Phase 1: Managed by admin only

// Privacy Settings
define('CONST_ENCRYPT_GOALS_BY_DEFAULT', true); // Already enabled in existing system
define('CONST_LEADERBOARD_OPT_IN_DEFAULT', false); // Users must opt-in to appear on leaderboard
define('CONST_ENABLE_LEADERBOARD', true); // Keep leaderboard feature (with opt-in)

// Feature Flags for Phase 1
define('CONST_SHOW_ADMIN_DASHBOARD', false); // Hide organization admin dashboard
define('CONST_ENABLE_MEMBER_GROUPS', false); // Disable organization/group features
define('CONST_ENABLE_ADMIN_OVERSIGHT', false); // Remove admin access to user data
define('CONST_ENABLE_USER_REGISTRATION', false); // Phase 1: No self-service signup yet

// Default User Roles
define('CONST_DEFAULT_USER_ROLE', 'INDIVIDUAL_USER'); // Role assigned to new users
define('CONST_SYSTEM_ADMIN_ROLE', 'SYSTEM_ADMIN'); // Internal admin role (no data access)

// ============================================================================
// END PHASE 1 CONFIGURATION
// ============================================================================
...
// IMPORTANT: Set these values in your environment or update them here
define('CONST_SMTP_HOST', ''); // e.g., 'smtp.gmail.com' or 'smtp.sendgrid.net'
define('CONST_SMTP_PORT', 587); // 587 for TLS, 465 for SSL
define('CONST_SMTP_USERNAME', ''); // Your SMTP username
define('CONST_SMTP_PASSWORD', ''); // Your SMTP password (use environment variable in production)
define('CONST_SMTP_ENCRYPTION', 'tls'); // 'tls' or 'ssl'
define('CONST_SMTP_FROM_EMAIL', ''); // e.g., 'noreply@yourdomain.com'
...
define('CONST_RECAPTCHA_SITE_KEY', ''); // Get from https://www.google.com/recaptcha/admin
define('CONST_RECAPTCHA_SECRET_KEY', ''); // Get from https://www.google.com/recaptcha/admin
define('CONST_RECAPTCHA_THRESHOLD', 0.5); // Score threshold (0.0 = bot, 1.0 = human)

// Application URLs (used in emails)
define('CONST_APP_URL', 'http://localhost'); // Base URL - UPDATE THIS for production!

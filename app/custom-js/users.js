var usersfuncs={
       ...
       console.log(resp);
		...
		if(otherparams.mode=='editrecord'){
			...
			if(user_id!=''){
				...
				let secondary_email = resp[1].record_details.secondary_email || '';
				...
				let residence_phone = resp[1].record_details.residence_phone || '';
				let residence_fax = resp[1].record_details.residence_fax || '';
				...
				let work_phone = resp[1].record_details.work_phone || '';
				let work_phoneepabx = resp[1].record_details.work_phoneepabx || '';
				let work_fax = resp[1].record_details.work_fax || '';
				let work_secretary_name = resp[1].record_details.work_secretary_name || '';
				let work_secretary_mobile = resp[1].record_details.work_secretary_mobile || '';
				let work_secretary_email = resp[1].record_details.work_secretary_email || '';
               ...
               contobj.find("#add_form_field_spouse_dob").datepicker('setDate', spousedob!=''?new Date(spousedob):null);
               ...
               contobj.find("#add_form_field_children").val(spousechildren); 
				...
				contobj.find("#add_form_field_secondary_email").val(secondary_email).siblings('.email-icon-form-input').data('url',`mailto:${secondary_email}`).toggleClass('d-none', secondary_email=='');
				...
				contobj.find("#add_form_field_resphone").val(residence_phone);
				contobj.find("#add_form_field_resfax").val(residence_fax);
				...
				contobj.find("#add_form_field_workphone").val(work_phone);
				contobj.find("#add_form_field_workphoneepabx").val(work_phoneepabx);
				contobj.find("#add_form_field_workfax").val(work_fax);
				...
				contobj.find("#add_form_field_workSecretaryName").val(work_secretary_name);
				contobj.find("#add_form_field_workSecretaryMobile").val(work_secretary_mobile);
				contobj.find("#add_form_field_workSecretaryEmail").val(work_secretary_email);
			...
			if(user_id!=''){
				...
				console.log(resp[1].record_details);
				...
				contobj.find("#view_form_field_email_text").text(`${email}`).toggleClass('d-none', email=='');
				contobj.find("#view_form_field_secondary_email").attr('href',`mailto:${secondary_email}`).toggleClass('d-none', secondary_email=='');
				contobj.find("#view_form_field_secondary_email_text").text(`${secondary_email}`).toggleClass('d-none', secondary_email=='');
				contobj.find("#view_form_field_mobile").attr('href',`https://wa.me/${wa_num}`).toggleClass('d-none', mobile=='');
				contobj.find("#view_form_field_mobile_text").text(`${wa_num}`).toggleClass('d-none', mobile=='');
				contobj.find("#view_form_field_mobile_tel").attr('href',`tel:${wa_num}`).toggleClass('d-none', mobile=='');
				contobj.find("#view_form_field_mobile_tel_text").html(`${wa_num}`).toggleClass('d-none', mobile=='');
				contobj.find("#view_form_field_mobile2").attr('href',`tel:${mobile2_num}`).toggleClass('d-none', mobile==mobile2 || mobile2=='');
				contobj.find("#view_form_field_mobile2_text").text(`${mobile2_num}`).toggleClass('d-none', mobile==mobile2 || mobile2=='');
				...
				contobj.find("#view_form_field_resphone").text("Phone: "+residence_phone).toggleClass('d-none', residence_phone=='');
				contobj.find("#view_form_field_resfax").text("Fax: "+residence_fax).toggleClass('d-none', residence_fax=='');
				...
				contobj.find("#view_form_field_prime_business").text(work_type).toggleClass('d-none', work_type=='');
				contobj.find("#view_form_field_secondary_business").text(work_ind).toggleClass('d-none', work_ind=='');
				...
				contobj.find("#view_form_field_workphone").text("Phone: "+work_phone).toggleClass('d-none', work_phone=='');
				contobj.find("#view_form_field_workphoneepabx").text("Phone Epabx: "+work_phoneepabx).toggleClass('d-none', work_phoneepabx=='');
				contobj.find("#view_form_field_workfax").text("Fax:"+work_fax).toggleClass('d-none', work_fax=='');

				contobj.find("#view_form_field_workSecretaryName").text(work_secretary_name).toggleClass('d-none', work_secretary_name=='');
				contobj.find("#view_form_field_workSecretaryMobile").text(work_secretary_mobile).toggleClass('d-none', work_secretary_mobile=='');
				contobj.find("#view_form_field_workSecretaryEmail").text(work_secretary_email).toggleClass('d-none', work_secretary_email=='');
	...
	handleUpdateUserResponse:function(resp){
		...
		if(resp.error_code==0){
			...
			// }else{
				...
				let secondary_email = $("#add_form_field_secondary_email").val().trim();
				...
				$("#add_form_field_secondary_email").siblings('.email-icon-form-input').data('url',mailto).toggleClass('d-none',mailto=='');
	...
	validateUserDetails:function(opts){
		...
		let secondary_email=$.trim(frm.find('#add_form_field_secondary_email').val());
...
// 		}
	...
	openAddUserForm:function(e){
		...
		$("#add_form_field_secondary_email").val('').siblings('.email-icon-form-input').data('url','').toggleClass('d-none',true);

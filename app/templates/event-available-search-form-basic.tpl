<div id="search_evrecords" class="row ">
	<div class=" col-lg-12 col-sm-12">
		<form class="form-inline search-form" name="event_search_form" onsubmit="return evregfuncs.doEventSearch(this);">
						...
						<div class="col-lg-12 col-sm-12">
							<div class="row">
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 form-group ">
									...
									<input type="text" id="search-field_name"  placeholder="Event's name has" class="form-control srchfld" style="height: 32px;width: 100%;" maxlength="100" data-type="CONTAINS" data-fld="name" />
								</div>

								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 form-group ">
									<label class="" style="font-weight: normal; white-space: nowrap;" for="search-field_description" >Event's Description</label>
									<input type="text" id="search-field_description"  placeholder="Event's description has" class="form-control srchfld" style="height: 32px;width: 100%;" maxlength="300" data-type="CONTAINS" data-fld="description"  />
								</div>

								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 form-group ">
									<label class="" style="font-weight: normal; white-space: nowrap;" for="search-field_venue" >Event's Venue</label>
									<input type="text" id="search-field_venue"  placeholder="Event's venue address has" class="form-control srchfld" style="height: 32px;width: 100%;" maxlength="300" data-type="CONTAINS" data-fld="venue"  />
								</div>

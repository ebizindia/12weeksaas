<?php
define('RESOURCE_VERSION',1); //used for version number to prevent caching of js and css
...
define('CONST_MAIL_SENDERS_EMAIL', 'noreply@ebizindia.com');
...
define('CONST_SECRET_ACCESS_KEY', '%%12WEEK***==***12W%%');
...
define('CONST_APP_PATH_FROM_ROOT', '/app'); // '' if the app is hosted at the root level else /path/to/the/dir/from/root without the leading slash but with the trailing slash, eg. /sites/trcnew
define('CONST_APP_FULL_PHYSICAL_PATH', preg_replace("/^(.*?)[\/\\\\]$/","$1",realpath(dirname(__FILE__))));
define('CONST_HOST', !empty($_SERVER['HTTP_HOST'])?$_SERVER['HTTP_HOST']:'12week.ebizindia.com');
...
define('CONST_LICENSED_TO', 'Ebizindia');

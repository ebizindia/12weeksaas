...
if (file_exists($config_file)) {
    ...
    require_once dirname(__FILE__) . '/app/includes/ebiz-autoload.php';
    $use_main_db = true;
} else {
...
try {
    ...
    if ($use_main_db) {
        ...
        $db = \eBizIndia\PDOConn::getInstance();
        $table_prefix = CONST_TBL_PREFIX ?? '';
    } else {
        $dsn = "mysql:host=" . CONST_DB_CREDS['mysql']['host'] . ";dbname=" . CONST_DB_CREDS['mysql']['db'] . ";charset=utf8mb4";
        $db = new PDO($dsn, CONST_DB_CREDS['mysql']['user'], CONST_DB_CREDS['mysql']['pswd'], [
